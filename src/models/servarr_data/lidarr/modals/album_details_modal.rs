...
use crate::{
  ...
  models::{
    ...
    lidarr_models::{Album, Artist, LidarrHistoryItem, LidarrRelease, Track, TrackFile},
    ...
    AlbumDetailsModal {
      ...
      album_details_tabs: TabState::new(vec![
        TabRoute {
          ...
          help: build_context_clue_string(&ALBUM_DETAILS_CONTEXT_CLUES),
          contextual_help: Some(build_context_clue_string(
            &ALBUM_DETAILS_CONTEXTUAL_CONTEXT_CLUES,
          )),
          config: None,
        },
        TabRoute {
          ...
          help: build_context_clue_string(&ALBUM_HISTORY_CONTEXT_CLUES),
        ...
        TabRoute {
          ...
          help: build_context_clue_string(&MANUAL_ALBUM_SEARCH_CONTEXT_CLUES),
          contextual_help: Some(build_context_clue_string(&DETAILS_CONTEXTUAL_CONTEXT_CLUES)),
          config: None,
        },
      ]),
