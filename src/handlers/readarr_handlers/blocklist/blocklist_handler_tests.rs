...
mod tests {
  ...
  use crate::handlers::readarr_handlers::blocklist::{BlocklistHandler, blocklist_sorting_options};
  ...
  mod test_handle_delete {
    ...
    fn test_delete_blocklist_item_prompt() {
      ...
      BlocklistHandler::new(DELETE_KEY, &mut app, ActiveReadarrBlock::Blocklist, None).handle();

      assert_navigation_pushed!(app, ActiveReadarrBlock::DeleteBlocklistItemPrompt.into());
    }
  ...
  mod test_handle_left_right_action {
    ...
    fn test_blocklist_tab_left(#[values(true, false)] is_ready: bool) {
      ...
      app.data.readarr_data.main_tabs.set_index(2);
    ...
    fn test_blocklist_left_right_prompt_toggle(
      ...
      BlocklistHandler::new(key, &mut app, active_readarr_block, None).handle();
  ...
  mod test_handle_submit {
    ...
    fn test_blocklist_submit() {
      ...
      BlocklistHandler::new(SUBMIT_KEY, &mut app, ActiveReadarrBlock::Blocklist, None).handle();

      assert_navigation_pushed!(app, ActiveReadarrBlock::BlocklistItemDetails.into());
    }
    ...
    #[case(
      ActiveReadarrBlock::Blocklist,
      ActiveReadarrBlock::DeleteBlocklistItemPrompt,
      ReadarrEvent::DeleteBlocklistItem(3)
    )]
    #[case(
      ActiveReadarrBlock::Blocklist,
      ActiveReadarrBlock::BlocklistClearAllItemsPrompt,
      ReadarrEvent::ClearBlocklist
    )]
    ...
    fn test_blocklist_prompt_decline_submit(
      ...
      assert_navigation_popped!(app, ActiveReadarrBlock::Blocklist.into());
    }
  }
  ...
  mod test_handle_esc {
    ...
    fn test_esc_blocklist_item_details() {
      let mut app = App::test_default();
      app.push_navigation_stack(ActiveReadarrBlock::Blocklist.into());
      app.push_navigation_stack(ActiveReadarrBlock::BlocklistItemDetails.into());
    ...
    fn test_default_esc(#[values(true, false)] is_ready: bool) {
      ...
      BlocklistHandler::new(ESC_KEY, &mut app, ActiveReadarrBlock::Blocklist, None).handle();
  ...
  mod test_handle_key_char {
    ...
    fn test_clear_blocklist_key() {
      ...
      assert_navigation_pushed!(app, ActiveReadarrBlock::BlocklistClearAllItemsPrompt.into());
    }
  ...
  #[test]
  fn test_blocklist_sorting_options_author_name() {
    ...
    assert_str_eq!(sort_option.name, "Author Name");
  }
  ...
  fn test_blocklist_handler_accepts() {
    ActiveReadarrBlock::iter().for_each(|active_readarr_block| {
      if BLOCKLIST_BLOCKS.contains(&active_readarr_block) {
        assert!(BlocklistHandler::accepts(active_readarr_block));
      } else {
        assert!(!BlocklistHandler::accepts(active_readarr_block));
      }
    })
