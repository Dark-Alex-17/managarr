...
mod tests {
  ...
  mod test_handle_scroll_up_and_down {
    ...
    #[test]
    fn test_series_overview_scroll_up() {
      let mut app = app_with_series_overview();
    ...
    #[test]
    fn test_series_overview_scroll_up_no_op_when_not_ready() {
      let mut app = app_with_series_overview();
      set_offset(&mut app, 2);
      app.is_loading = true;
    ...
    #[test]
    fn test_series_overview_scroll_down() {
      let mut app = app_with_series_overview();
    ...
    #[test]
    fn test_series_overview_scroll_down_no_op_when_not_ready() {
      let mut app = app_with_series_overview();
      app.is_loading = true;
  ...
  mod test_handle_home_end {
    ...
    #[test]
    fn test_series_overview_home_no_op_when_not_ready() {
      let mut app = app_with_series_overview();
      set_offset(&mut app, 3);
      app.is_loading = true;
    ...
    #[test]
    fn test_series_overview_end_no_op_when_not_ready() {
      let mut app = app_with_series_overview();
      app.is_loading = true;
  ...
  mod test_handle_esc {
    ...
    #[test]
    fn test_series_overview_esc_tears_down_the_series_overview_modal() {
      let mut app = app_with_series_overview();
    ...
    #[test]
    fn test_series_overview_esc_tears_down_the_modal_even_when_loading() {
      let mut app = app_with_series_overview();
      app.is_loading = true;
  ...
  mod test_handle_key_char {
    ...
    #[test]
    fn test_series_overview_refresh_key() {
      let mut app = app_with_series_overview();
    ...
    #[test]
    fn test_series_overview_refresh_key_no_op_when_not_ready() {
      let mut app = app_with_series_overview();
      app.is_loading = true;
      app.is_routing = false;
  ...
  #[test]
  fn test_scrolling_the_overview_does_not_mutate_the_series_record() {
    let mut app = app_with_series_overview();
    ...
    assert_eq!(overview_offset(&app), 1);
    assert_eq!(
      app.data.sonarr_data.series.current_selection().overview,
      overview_before
    );
  }

  #[test]
  fn test_series_overview_handler_accepts() {
    ActiveSonarrBlock::iter().for_each(|active_sonarr_block| {
      if SERIES_OVERVIEW_BLOCKS.contains(&active_sonarr_block) {
        assert!(
          SeriesOverviewHandler::accepts(active_sonarr_block),
          "{active_sonarr_block} is not accepted by the SeriesOverviewHandler"
        );
      } else {
        assert!(
          !SeriesOverviewHandler::accepts(active_sonarr_block),
          "{active_sonarr_block} is wrongly accepted by the SeriesOverviewHandler"
        );
      }
    });
  }
  ...
  #[test]
  fn test_series_overview_handler_dispatches_no_network_events() {
    let mut app = app_with_series_overview();
    ...
    for key in [
      ...
      SeriesOverviewHandler::new(key, &mut app, ActiveSonarrBlock::SeriesOverview, None).handle();
  ...
  #[test]
  fn test_series_overview_handler_is_not_ready_when_loading() {
    let mut app = app_with_series_overview();
    app.is_loading = true;

    let handler = SeriesOverviewHandler::new(
      DEFAULT_KEYBINDINGS.up.key,
      &mut app,
      ActiveSonarrBlock::SeriesOverview,
      None,
  ...
  #[test]
  fn test_series_overview_handler_is_not_ready_when_the_modal_is_absent() {
    let mut app = app_with_series_overview();
  ...
  #[test]
  fn test_series_overview_handler_is_ready() {
    let mut app = app_with_series_overview();
  ...
  #[test]
  fn test_series_overview_handler_ignores_special_keys_for_textbox_input() {
    let mut app = app_with_series_overview();
  ...
  fn app_with_series_overview() -> App<'static> {
