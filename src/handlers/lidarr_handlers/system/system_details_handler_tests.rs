...
mod tests {
  ...
  mod test_handle_scroll_up_and_down {
    ...
    fn test_log_details_scroll_no_op_when_not_ready(
      ...
      SystemDetailsHandler::new(key, &mut app, ActiveLidarrBlock::SystemLogs, None).handle();
    ...
    fn test_tasks_scroll(
      ...
      let mut app = App::test_default();
      app.push_navigation_stack(ActiveLidarrBlock::System.into());
      app.data.lidarr_data.updates = ScrollableText::with_string("Test 1\nTest 2".to_owned());
      app
        .data
        .lidarr_data
        .tasks
        .set_items(simple_stateful_iterable_vec!(LidarrTask, String, name));

      SystemDetailsHandler::new(key, &mut app, ActiveLidarrBlock::SystemTasks, None).handle();
    ...
    fn test_queued_events_scroll(
      ...
      SystemDetailsHandler::new(key, &mut app, ActiveLidarrBlock::SystemQueuedEvents, None)
        .handle();

      assert_str_eq!(
        app.data.lidarr_data.queued_events.current_selection().name,
        "Test 2"
      );
    ...
    fn test_system_updates_scroll() {
      ...
      assert_eq!(app.data.lidarr_data.updates.offset, 0);
      ...
      assert_eq!(app.data.lidarr_data.updates.offset, 1);
    }
  ...
  mod test_handle_home_end {
    ...
    fn test_tasks_home_end() {
      let mut app = App::test_default();
      app.push_navigation_stack(ActiveLidarrBlock::System.into());
      app.data.lidarr_data.updates =
        ScrollableText::with_string("Test 1\nTest 2\nTest 3".to_owned());
      app
        .data
        .lidarr_data
        .tasks
        .set_items(extended_stateful_iterable_vec!(LidarrTask, String, name));
  ...
  mod test_handle_left_right_action {
    ...
    fn test_handle_log_details_left_right() {
      let active_lidarr_block = ActiveLidarrBlock::SystemLogs;
      let mut app = App::test_default();
      app.push_navigation_stack(ActiveLidarrBlock::System.into());
      app
        .data
      ...
      assert_eq!(app.data.lidarr_data.log_details.items[0].to_string(), "t1");
      assert_eq!(app.data.lidarr_data.log_details.items[1].to_string(), "t22");
      ...
      assert_eq!(app.data.lidarr_data.log_details.items[0].to_string(), "1");
      assert_eq!(app.data.lidarr_data.log_details.items[1].to_string(), "22");
      ...
      assert_eq!(app.data.lidarr_data.log_details.items[0].to_string(), "");
      assert_eq!(app.data.lidarr_data.log_details.items[1].to_string(), "2");
      ...
      assert_eq!(app.data.lidarr_data.log_details.items[0].to_string(), "");
      assert_eq!(app.data.lidarr_data.log_details.items[1].to_string(), "");
  ...
  mod test_handle_submit {
    ...
    fn test_system_tasks_submit() {
      let mut app = App::test_default();
      app.push_navigation_stack(ActiveLidarrBlock::System.into());
      app.data.lidarr_data.updates = ScrollableText::with_string("Test".to_owned());

      SystemDetailsHandler::new(SUBMIT_KEY, &mut app, ActiveLidarrBlock::SystemTasks, None)
        .handle();

      assert_navigation_pushed!(app, ActiveLidarrBlock::SystemTaskStartConfirmPrompt.into());
    }
    ...
    fn test_system_tasks_submit_no_op_when_not_ready() {
      ...
      assert_eq!(
        ...
        ActiveLidarrBlock::SystemTasks.into()
      );
    }
    ...
    fn test_system_tasks_start_task_prompt_confirm_submit() {
      ...
      app.push_navigation_stack(ActiveLidarrBlock::SystemTasks.into());
      app.push_navigation_stack(ActiveLidarrBlock::SystemTaskStartConfirmPrompt.into());
      ...
      assert_some_eq_x!(
        ...
        &LidarrEvent::StartTask(LidarrTaskName::default())
      );
      assert_navigation_popped!(app, ActiveLidarrBlock::SystemTasks.into());
    }
  ...
  mod test_handle_esc {
    ...
    fn test_esc_system_logs(#[values(true, false)] is_ready: bool) {
      ...
      app.push_navigation_stack(ActiveLidarrBlock::System.into());
      app.push_navigation_stack(ActiveLidarrBlock::SystemLogs.into());
      app
        .data
        .lidarr_data
        .log_details
      ...
      SystemDetailsHandler::new(ESC_KEY, &mut app, ActiveLidarrBlock::SystemLogs, None).handle();

      assert_navigation_popped!(app, ActiveLidarrBlock::System.into());
      assert_is_empty!(app.data.lidarr_data.log_details.items);
    }
    ...
    fn test_esc_system_tasks(#[values(true, false)] is_ready: bool) {
      ...
      SystemDetailsHandler::new(ESC_KEY, &mut app, ActiveLidarrBlock::SystemTasks, None).handle();
    ...
    fn test_esc_system_queued_events(#[values(true, false)] is_ready: bool) {
      ...
      app.is_loading = is_ready;
      app.push_navigation_stack(ActiveLidarrBlock::System.into());
      app.push_navigation_stack(ActiveLidarrBlock::SystemQueuedEvents.into());
      app
        .data
        .lidarr_data
        .queued_events
    ...
    fn test_esc_system_updates(#[values(true, false)] is_ready: bool) {
      ...
      SystemDetailsHandler::new(ESC_KEY, &mut app, ActiveLidarrBlock::SystemUpdates, None).handle();
  ...
  mod test_handle_key_char {
    ...
    fn test_system_tasks_start_task_prompt_confirm() {
      ...
      assert_eq!(
        app.data.lidarr_data.prompt_confirm_action,
        Some(LidarrEvent::StartTask(LidarrTaskName::default()))
      );
      assert_navigation_popped!(app, ActiveLidarrBlock::SystemTasks.into());
    }
  }
  ...
  fn test_system_details_handler_accepts() {
    ActiveLidarrBlock::iter().for_each(|active_lidarr_block| {
      if SYSTEM_DETAILS_BLOCKS.contains(&active_lidarr_block) {
        assert!(SystemDetailsHandler::accepts(active_lidarr_block));
      } else {
        assert!(!SystemDetailsHandler::accepts(active_lidarr_block));
      }
    })
